...
_AGENT_INSTRUCTION = (
    ...
    "- How-much-I-owe / combined totals (traffic + iqama, or iqama fees with "
    "dependents) → government-fee-payment-draft only and stay on it. "
    "On that combined pattern: if dependents omitted pass dependents=2; "
    "if codes omitted use 101 and 205; include_express=false unless asked.\n"
    "- Iqama docs/eligibility → iqama-renewal-status.\n"
    "- Appointment slots by city/date → appointment-slot-finder.\n\n"
